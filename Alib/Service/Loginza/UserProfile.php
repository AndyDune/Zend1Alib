 ...
 * @version 1.0
 */
namespace Alib\Service\Loginza;
class UserProfile
{
    /**
     * Профиль
    ...
    {
        if (isset($this->profile->name->full_name) and $this->profile->name->full_name)
        {
            return $this->profile->name->full_name;
        }
        elseif (
            (isset($this->profile->name->first_name) and $this->profile->name->first_name)
            || (isset($this->profile->name->last_name) and $this->profile->name->last_name)
            )
        {
